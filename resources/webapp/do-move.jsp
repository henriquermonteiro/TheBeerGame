...
<%
    ...
    if(request.getMethod().equals("POST")){
        ...
        String move = request.getParameter("move").toString();
        ...
        String recv;
        URL checkin_json = new URL(request.getScheme(), request.getServerName(), request.getServerPort(), "/makeorder?game-name=" + URLEncoder.encode(game, "UTF-8").replace("+", "%20") + "&player-name=" + URLEncoder.encode(user, "UTF-8").replace("+", "%20") + "&player-move=" + URLEncoder.encode(move, "UTF-8").replace("+", "%20"));
