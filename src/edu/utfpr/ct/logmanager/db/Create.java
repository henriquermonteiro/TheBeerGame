...
public class Create {
    ...
    private final String game = "create table game( "
            ...
            + "sellingUnitProfit float not null check(sellingUnitProfit >= 0), "
    ...
    private final String tableDemandProfile = "create table demand_profile("
            + "	demand_type int,"
    ...
    public void createTables() {
        ...
        createTable(connection, "demand", tableDemand);
        createTable(connection, "demand_profile", tableDemandProfile);
