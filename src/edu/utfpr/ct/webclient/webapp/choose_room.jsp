    ...
    <jsp:include page="resources/body_begin.jsp" />
        ...
        <dialog id="dialog" class="mdl-dialog">
            ...
            <div class="mdl-dialog__content">
                <p  id="dlg_text">
                    <%=(localize.getTextForKey(ClientLocalizationKeys.CHOOSE_PW_TEXT)) %>
                </p>
            ...
            <div class="mdl-dialog__actions">
                <button id="call_button" type="button" class="mdl-button" onclick="enter_room()"><%=(localize.getTextForKey(ClientLocalizationKeys.CHOOSE_PW_ENTER)) %></button>
                <button type="button" class="mdl-button close" onclick="close_dialog()"><%=(localize.getTextForKey(ClientLocalizationKeys.CHOOSE_PW_CLOSE)) %></button>
            </div>
        </dialog>
